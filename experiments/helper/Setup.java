...
import org.cloudbus.cloudsim.adaptive.AdaptiveDatacenterBroker;
...
public class Setup {
	...
	/**
	 * Creates the datacenter for SAd package.
	 */
	public static AdaptiveDatacenter createAdaptiveDatacenter
		...
		// 6. Finally, we need to create a PowerDatacenter object.
		AdaptiveDatacenter datacenter = null;
		try {
			datacenter = new AdaptiveDatacenter(
	...
	/**
	 * Creates the adaptive datacenter for stability.
	 */
	public static AdaptiveDatacenterStability createAdaptiveDatacenterStability 
			(String name, List<? extends Host> hostList){
		...
		// 6. Finally, we need to create a PowerDatacenter object.
		AdaptiveDatacenterStability datacenter = null;
		try {
			datacenter = new AdaptiveDatacenterStability(
					name, characteristics, new VmAllocationPolicyAdaptation(hostList), storageList, 0);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	/**
	 * Creates the datacenter for SAw package.
	 */
	public static AwareDatacenter createAwareDatacenter(String name, List<AdvHost> hostList){
		...
		// 6. Finally, we need to create a PowerDatacenter object.
		AwareDatacenter datacenter = null;
		try {
			datacenter = new AwareDatacenter(
					name, characteristics, new VmAllocationPolicyAdaptation(hostList), storageList, 0);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	/**
	 * Creates the broker for adaptive architecture.
	 * 
	 * @return the datacenter broker
	 */
	public static AdaptiveDatacenterBroker createAdaptiveBroker() {
		AdaptiveDatacenterBroker broker = null;
		try {
			broker = new AdaptiveDatacenterBroker("Broker");
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(0);
		}
	...
	/**
	 * Creates the broker for adaptive architecture
	 * for handling runtime workload
	 * 
	 * @return the datacenter broker
	 */
	public static AdaptiveDynamicDatacenterBroker createAdaptiveDynamicBroker() {
		AdaptiveDynamicDatacenterBroker broker = null;
		try {
			broker = new AdaptiveDynamicDatacenterBroker("Broker");
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(0);
		}
...
/*	public static NAwareDatacenterBrokerSingleQueue createNAwareDatacenterBrokerSingleQueue() {
		NAwareDatacenterBrokerSingleQueue broker = null;
		try {
			broker = new NAwareDatacenterBrokerSingleQueue("Broker");
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(0);
		}
...
*/
/*	public static NAwareDatacenterBrokerMultipleQueues createNAwareDatacenterBrokerMultipleQueues() {
		NAwareDatacenterBrokerMultipleQueues broker = null;
		try {
			broker = new NAwareDatacenterBrokerMultipleQueues("Broker");
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(0);
		}
...
*/
	/**
	 * Creates the broker for aware architecture.
	 * 
	 * @return the datacenter broker
	 */
	public static AwareDynamicDatacenterBroker createAwareDynamicDatacenterBorker() {
		AwareDynamicDatacenterBroker broker = null;
		try {
			broker = new AwareDynamicDatacenterBroker("Broker");
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(0);
		}

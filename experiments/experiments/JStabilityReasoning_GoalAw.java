...
public class JStabilityReasoning_GoalAw {
	...
	public static void main(String[] args) {
	    ...
	    try {
			...
			OutputStream output = new FileOutputStream(resultsFolder + "JStabilityReasoning_GoalAw_S4_output.txt");
			Log.setOutput(output);
			
			Log.printLine("Starting JStabilityReasoning_GoalAw Experiment...");
			Log.printLine("running self-aware architecture (goal-awareness, using queueing theory and markov model) ");

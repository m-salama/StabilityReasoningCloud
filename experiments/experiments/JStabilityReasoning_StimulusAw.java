...
public class JStabilityReasoning_StimulusAw {
	...
	public static void main(String[] args) {
	    ...
	    try {
			...
			OutputStream output = new FileOutputStream(resultsFolder + "JStabilityReasoning_StimulusAw_S0_output.txt");
			Log.setOutput(output);
			
			Log.printLine("Starting JStabilityReasoning_StimulusAw Experiment...");
			Log.printLine("running self-aware architecture (stimulus-awareness) on RUBis and WorldCup1998 workload");
			Log.printLine("for service type #0");

...
public class JStabilityReasoning_TimeAw {
	...
	public static void main(String[] args) {
	    ...
	    try {
			...
			OutputStream output = new FileOutputStream(resultsFolder + "JStabilityReasoning_TimeAw_S4_output.txt");
			Log.setOutput(output);
			
			Log.printLine("Starting JStabilityReasoning_TimeAw Experiment...");
			Log.printLine("running self-aware architecture (time-awareness, simple learning algorithm) ");

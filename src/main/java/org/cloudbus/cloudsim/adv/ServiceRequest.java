...
/**
 * ServiceRequest is an extension to the serviceRequest. It stores, despite all the information encapsulated in
 * the ServiceRequest, the ID of the VM running it.
 * 
 * @author mxs512
 */

...
/**
 * AdaptiveDatacenter class is extending CloudSim Datacenter, with adaptation capabilities.
 * 
 * @author m.salama
 * @version SAdCloudSim
 */
public class AdaptiveDatacenter extends Datacenter {

	/** The cloudlet submited. */
	private double cloudletSubmitted;

	/** The Self-Adaptive Cloud Architecture */
	private static SelfAdaptiveArchitecture selfAdaptiveArchitecture;
					...
					throws Exception 
	{
		...
		// SAd-CloudSim: Create Self-Adaptive architecture
		//adaptiveArchitecture = new AdaptiveArchitecture("AdaptiveArchitecture");
		selfAdaptiveArchitecture = SelfAdaptiveArchitecture.getInstance();
		selfAdaptiveArchitecture.setDatacenterId(this.getId());
	...
	protected void recordAdaptation(String adaptationTag) {
		...
		SelfAdaptiveArchitecture.getInstance().addAdaptationRecord(
		...
		int datacenterId = SelfAdaptiveArchitecture.getInstance().getDatacenterId();
...
//						currentTime, this.getId(), timeFrameDatacenterEnergy);
	...
	public static void setOperationHistory(LinkedList<OperationRecord> operationHistory) {
		AdaptiveDatacenter.operationHistory = operationHistory;
	}
	...
	public void printSelfAdaptationResults() {
		double adaptationOverhead = SelfAdaptiveArchitecture.getInstance().getAdaptationOverhead();
		LinkedList<AdaptationRecord> adaptationHistory = SelfAdaptiveArchitecture.getInstance().getAdaptationHistory();

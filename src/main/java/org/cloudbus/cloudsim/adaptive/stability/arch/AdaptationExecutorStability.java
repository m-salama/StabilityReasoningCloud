...
public class AdaptationExecutorStability extends SimEntity {

	/** The AdaptationExecutor singleton instance. */
	private static AdaptationExecutorStability adaptationExecutor;
	
	
	private int datacenterId;
	
	
	public AdaptationExecutorStability(String name) {
		super(name);
	}
    ...
    */
    public static AdaptationExecutorStability getInstance(){
        if(adaptationExecutor == null){
        	adaptationExecutor = new AdaptationExecutorStability("AdaptationExecutorStability");
        }
	...
	public void processEvent(SimEvent ev) {
		...
		case CloudSimTags.SAD_EXECUTE_ADAPTATION_STABILITY:
	...
	protected void processOtherEvent(SimEvent ev) {
		...
		Log.printLine(getName() + ".processOtherEvent(): " + "Error - event unknown " + ev.getTag());
	}

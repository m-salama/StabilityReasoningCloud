...
public class Detector extends SimEntity {
    ...
    */
	...
	public void processEvent(SimEvent ev) {
		...
		case CloudSimTags.SAD_DETECT_VIOLATIONS:
	...
	protected void processDetectViolations(SimEvent ev){
		...
		adaptationEngineId = AdaptationEngine.getInstance().getId();
		...
		if (violationDetected){
			send(adaptationEngineId, CloudSim.getMinTimeBetweenEvents(), CloudSimTags.SAD_ADAPTATION_DECISION);
		} else {

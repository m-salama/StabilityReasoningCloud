...
public class ServiceList {
	 ...
	 * @return the by id
	 */
	public static <T extends Service> T getById(List<T> cloudletList, int id) {
		for (T cloudlet : cloudletList) {
			if (cloudlet.getServiceId() == id) {
				return cloudlet;
			}
		}
		return null;
	 ...
	 */
	public static <T extends Service> int getPositionById(List<T> cloudletList, int id) {
		int i = 0 ;
	        for (T cloudlet : cloudletList) {
			if (cloudlet.getServiceId() == id) {
				return i;
	 ...
	 * @post $none
	 */
	public static <T extends Service> void sort(List<T> cloudletList) {
